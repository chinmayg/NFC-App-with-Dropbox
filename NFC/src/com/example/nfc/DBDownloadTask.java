...
public class DBDownloadTask extends AsyncTask<Void, Long, Boolean> {
	...
	public DBDownloadTask(Context context, String dropboxPath) {
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            ...
            String cachePath = mContext.getCacheDir().getAbsolutePath() + "/" + file.fileName();
